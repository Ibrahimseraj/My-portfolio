            ...
            <div className='memorygame'>
                ...
                <div className='flame'>
                  ...
                  <div className='flame-links'>
                    <div><h3 className='livesite'><a href='https://flame-u3kq.onrender.com/' target='_blank' rel="noreferrer">Live Site</a></h3></div>
                    <h3>|</h3>
                ...
                <div className='flame'>
                  ...
                  <div className='flame-links'>
                    <div><h3 className='livesite'><a href='https://profile-front-end-chi.vercel.app/' target='_blank' rel="noreferrer">Live Site</a></h3></div>
                    <h3>|</h3>
                    <div><h3 className='projectsgithup'><a href='https://github.com/Ibrahimseraj' target='_blank' rel="noreferrer">Githup repo</a></h3></div>
                  </div>
                </div>
            </div>
         </div>
